        ...
        <div class="pull-right p-r-15">
            <ul>
              ...
              <li class="header-icon dib"><i class="ti-email"></i>
               ...
               <li class="header-icon dib"><img class="avatar-img" src="assets/images/avatar/1.jpg" alt="" /> <span class="user-avatar">${loginGcuser.uName} <i class="ti-angle-down f-s-10"></i></span>
                    <div class="drop-down dropdown-profile">
                        ...
                        <div class="dropdown-content-body">
                            <ul>
                                ...
                                <li><a href="${pageContext.request.contextPath}/gcuserController/logout"><i class="ti-power-off"></i> <span>Logout</span></a></li>
                            </ul>
                        </div>
                    </div>
                </li> 
                ...
                <c:if test="${loginGcuser == null }">
                 ...
                 <li class="header-icon dib"><img class="avatar-img" src="assets/images/avatar/login.jpg" alt="" /> <span class="user-avatar">未登录 </span>
                    <div class="drop-down dropdown-profile">
                        
                        <div class="dropdown-content-body">
                            <ul>
                                <li><a href="${pageContext.request.contextPath}/pages/bk_login/login.jsp"><i class="ti-user"></i> <span>登陆</span></a></li>
                                <li><a href="${pageContext.request.contextPath}/pages/bk_login/register.jsp"><i class="ti-wallet"></i> <span>注册</span></a></li>
